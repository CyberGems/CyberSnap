...
public partial class SettingsWindow
{
    ...
    private void BuildSearchIndex()
    {
        ...
        var panelDefs = new (ScrollViewer Panel, string PageKey, string PageTitle)[]
        {
            ...
            (RecordingPanel,  "recording",     "Video & GIF"),
    ...
    private FrameworkElement? FindSettingControl(string settingKey)
    {
        ...
        return normalized switch
        {
            ...
            "giffps"                    => GifFpsCombo,
            "videoshowcursor"           => VideoShowCursorCheck,
            "gifshowcursor"             => GifShowCursorCheck,
            "gifenableseditor"          => GifOutcomeEditor,
            "opengiftrimmeraftercapture"=> GifOutcomeEditor,
            ...
            "videoenableeditor"         => VideoOutcomeEditor,
            "openvideotrimmeraftercapture" => VideoOutcomeEditor,
