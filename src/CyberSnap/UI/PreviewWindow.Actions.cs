...
{
    // â”€â”€â”€ Drag â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    protected override void OnMouseMove(System.Windows.Input.MouseEventArgs e)
    {
        ...
        if (Math.Abs(diff.X) > 6 || Math.Abs(diff.Y) > 6)
        {
            ...
            try
            {
                ...
                {
                    tmpFile = Path.Combine(Path.GetTempPath(), $"CyberSnap_{DateTime.Now:yyyyMMdd_HHmmss}.png");
    ...
    private void ShowPreviewOpenError(string message)
    {
        var body = HasSavedPreviewFileOnDisk()
            ? BuildPreviewFailureBody("CyberSnap could not open the saved file location. The file is still saved; open it from History or try again.", message)
            : BuildPreviewFailureBody("CyberSnap could not open the preview target. Capture again or check History for another copy.", message);
    ...
    {
        var body = HasSavedPreviewFileOnDisk()
            ? BuildPreviewFailureBody("CyberSnap could not start the drag. The file is still saved; open it from History or try again.", message)
            : BuildPreviewFailureBody("CyberSnap could not start the drag. The preview is still open; use Save or try the capture again.", message);
    ...
    // â”€â”€â”€ Dismiss (swipe right) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        try
        {
            ...
            else
            {
                var dlg = new SaveFileDialog
                {
                    ...
                    FileName = $"CyberSnap_{DateTime.Now:yyyyMMdd_HHmmss}.png",
                    DefaultExt = ".png"
                };
    ...
    private void ShowPreviewSaveError(string message)
    {
        var body = BuildPreviewFailureBody(
            "CyberSnap could not save the preview. Choose another folder or check write permissions.",
            message);
