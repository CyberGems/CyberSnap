...
public sealed partial class RegionOverlayForm : Form
{
    ...
    /// <summary>
    /// Raised when the capture-bar QR button is chosen. The overlay must close first so the
    /// standalone scanner can capture the live desktop instead of the frozen overlay image.
    /// </summary>
    public event Action? StandaloneScanRequested;
    /// <summary>
