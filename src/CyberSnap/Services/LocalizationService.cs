...
public static class LocalizationService
{
    ...
    [
        ...
        new("ar", "Arabic", "Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©", true),
        new("bg", "Bulgarian", "Ð‘ÑŠÐ»Ð³Ð°Ñ€ÑÐºÐ¸", false),
        new("ca", "Catalan", "CatalÃ ", false),
        new("cs", "Czech", "ÄŒeÅ¡tina", false),
        new("da", "Danish", "Dansk", false),
        new("de", "German", "Deutsch", false),
        new("el", "Greek", "Î•Î»Î»Î·Î½Î¹ÎºÎ¬", false),
        new("es", "Spanish", "EspaÃ±ol", false),
        new("et", "Estonian", "Eesti", false),
        new("fi", "Finnish", "Suomi", false),
        new("fr", "French", "FranÃ§ais", false),
        new("he", "Hebrew", "×¢×‘×¨×™×ª", true),
        new("hi", "Hindi", "à¤¹à¤¿à¤¨à¥à¤¦à¥€", false),
        ...
        new("ja", "Japanese", "æ—¥æœ¬èªž", false),
        new("ko", "Korean", "í•œêµ­ì–´", false),
        new("lt", "Lithuanian", "LietuviÅ³", false),
        new("lv", "Latvian", "LatvieÅ¡u", false),
        new("ms", "Malay", "Melayu", false),
        new("nb", "Norwegian BokmÃ¥l", "Norsk bokmÃ¥l", false),
        new("nl", "Dutch", "Nederlands", false),
        new("pl", "Polish", "Polski", false),
        new("pt-BR", "Portuguese (Brazil)", "PortuguÃªs (Brasil)", false),
        new("pt-PT", "Portuguese (Portugal)", "PortuguÃªs (Portugal)", false),
        new("ro", "Romanian", "RomÃ¢nÄƒ", false),
        new("ru", "Russian", "Ð ÑƒÑÑÐºÐ¸Ð¹", false),
        new("sk", "Slovak", "SlovenÄina", false),
        new("sl", "Slovenian", "SlovenÅ¡Äina", false),
        new("sr-Latn", "Serbian (Latin)", "Srpski (latinica)", false),
        new("sv", "Swedish", "Svenska", false),
        new("th", "Thai", "à¹„à¸—à¸¢", false),
        new("tr", "Turkish", "TÃ¼rkÃ§e", false),
        new("uk", "Ukrainian", "Ð£ÐºÑ€Ð°Ñ—Ð½ÑÑŒÐºÐ°", false),
        new("vi", "Vietnamese", "Tiáº¿ng Viá»‡t", false),
        new("zh-Hans", "Chinese (Simplified)", "ç®€ä½“ä¸­æ–‡", false),
        new("zh-Hant", "Chinese (Traditional)", "ç¹é«”ä¸­æ–‡", false),
    ];
