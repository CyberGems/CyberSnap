...
public static class AppDiagnostics
{
    ...
    public static string CurrentLogPath => Path.Combine(AppStoragePaths.LogDirectory, $"CyberSnap-{DateTime.Now:yyyyMMdd}.log");
    ...
    private static void PurgeOldLogFiles()
    {
        try
        {
            var logFiles = Directory.GetFiles(AppStoragePaths.LogDirectory, "CyberSnap-*.log")
