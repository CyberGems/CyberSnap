...
public static class OpenSourceTranslationRuntimeService
{
    ...
    private static readonly string RootDir = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "CyberSnap", "translate-local");
    ...
    private static string NormalizePythonError(string message)
    {
        ...
        {
            return "Existing local translation files were incomplete. Retry install and CyberSnap will rebuild them.";
        }
