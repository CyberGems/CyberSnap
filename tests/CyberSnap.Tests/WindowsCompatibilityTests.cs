...
public sealed class WindowsCompatibilityTests
{
    ...
    {
        var project = XDocument.Load(RepoPath("src", "CyberSnap", "CyberSnap.csproj"));
    ...
    {
        var manifest = File.ReadAllText(RepoPath("src", "CyberSnap", "app.manifest"));
    ...
    {
        var chrome = File.ReadAllText(RepoPath("src", "CyberSnap", "UI", "CyberSnapWindowChrome.cs"));
        var gdi = File.ReadAllText(RepoPath("src", "CyberSnap", "Native", "Gdi32.cs"));
        var user32 = File.ReadAllText(RepoPath("src", "CyberSnap", "Native", "User32.cs"));
    ...
    {
        var menu = File.ReadAllText(RepoPath("src", "CyberSnap", "Helpers", "WindowsMenuRenderer.cs"));
        var preview = File.ReadAllText(RepoPath("src", "CyberSnap", "UI", "PreviewWindow.xaml.cs"));
        var toast = File.ReadAllText(RepoPath("src", "CyberSnap", "UI", "ToastWindow.xaml.cs"));
        var setup = File.ReadAllText(RepoPath("src", "CyberSnap", "UI", "SetupWizard.xaml.cs"));
        ...
        Assert.Contains("CyberSnapWindowChrome.ApplyRoundedCorners(this, 18);", preview);
        Assert.Contains("CyberSnapWindowChrome.ApplyRoundedCorners(this, 12);", toast);
        Assert.Contains("CyberSnapWindowChrome.ApplyRoundedCorners(this, 12);", setup);
    }
    ...
    {
        var menu = File.ReadAllText(RepoPath("src", "CyberSnap", "Helpers", "WindowsMenuRenderer.cs"));
        var moreTools = File.ReadAllText(RepoPath("src", "CyberSnap", "Capture", "RegionOverlayForm.MoreToolsMenu.cs"));
