...
public sealed class CaptureOutputServiceTests
{
    ...
    public void SaveBitmapToTempPng_CreatesReadablePng()
    {
        ...
        try
        {
            ...
            tempPath = CaptureOutputService.SaveBitmapToTempPng(bitmap, "CyberSnap-test");
    ...
    {
        var source = File.ReadAllText(RepoPath("src", "CyberSnap", "Services", "CaptureOutputService.cs"));
