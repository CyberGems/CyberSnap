...
public sealed class BackgroundRuntimeJobServiceTests
{
    ...
    {
        var source = File.ReadAllText(RepoPath("src", "CyberSnap", "Services", "BackgroundRuntimeJobService.cs"));
    ...
    public void InterruptedRuntimeJobsPersistRecoveryStatus()
    {
        ...
        Assert.DoesNotContain("state.LastError = \"Interrupted because CyberSnap closed before setup finished.\";", normalizeBlock);
