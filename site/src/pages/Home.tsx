...
const showcase = [
  ...
  { title: "uploads", desc: "18 destinations: imgur, s3/r2/b2, dropbox, onedrive, immich, webdav, and more.", img: "uploads.webp" },
];

const faq = [
  { q: "what is CyberSnap?", a: "CyberSnap is a free, open-source screenshot and screen recording tool for windows. it replaces tools like sharex with a clean, modern interface." },
  { q: "is CyberSnap free?", a: "yes, completely free and open source under the gpl-3.0 license. no ads, no tracking, no premium tiers." },
  { q: "does CyberSnap work offline?", a: "yes. all capture, annotation, ocr, and recording features work fully offline. only uploads and google translate require internet." },
  { q: "what windows versions are supported?", a: "windows 10 (version 1903+) and windows 11. both x64 and arm64 are supported." },
  { q: "how does ocr work?", a: "CyberSnap uses the windows built-in ocr engine. no downloads or setup needed. it supports all languages installed in your windows language settings." },
  { q: "can i upload screenshots automatically?", a: "yes. CyberSnap supports auto-upload to 18 destinations: imgur, imgbb, catbox, litterbox, gyazo, file.io, uguu, tmpfiles, transfer.sh, dropbox, google drive, onedrive, azure blob, immich, ftp, sftp, webdav, s3-compatible storage (aws, cloudflare r2, backblaze b2), and custom http endpoints." },
  { q: "where are screenshots saved?", a: "by default in your pictures/CyberSnap folder. you can change this in settings along with the file format and naming pattern." },
  ...
  { q: "what translation services are supported?", a: "CyberSnap supports argos translate (fully offline, no api key needed) and google translate (requires internet). both support 35+ languages." },
  { q: "how is CyberSnap different from sharex?", a: "CyberSnap has a modern, clean interface with built-in sticker creation, ai redirects, image upscaling, and semantic image search. it focuses on being simple to use while still being powerful." },
  ...
  { q: "does CyberSnap have a portable version?", a: "yes. the downloads page includes both a windows installer (recommended) and a portable zip." },
  { q: "how do i update CyberSnap?", a: "installed builds can update through the app. you can also download the latest installer or portable build directly from the downloads page." },
  { q: "does CyberSnap support multiple monitors?", a: "yes. CyberSnap fully supports multi-monitor setups for capture, recording, and color picking. you can capture regions across monitors or target a specific screen." },
];
    ...
    <div className="space-y-2">
      <section className="relative pt-20 pb-24 sm:pt-24 sm:pb-28">
        ...
        <div className="mx-auto flex max-w-[760px] flex-col items-center text-center">
          <div className="mb-9 rounded-[2rem] border border-[#DDD5C7] bg-[#FFFDF8]/72 p-4 shadow-[0_24px_70px_rgba(72,57,34,0.13)] backdrop-blur">
            <img
              src={base + "CyberSnap-square.webp"}
              alt=""
      ...
      <Section title="built for privacy">
        <p className="max-w-[68ch] rounded-[1.15rem] border border-[#DDD5C7] bg-[#FFFDF8]/70 p-5 text-[15px] leading-relaxed text-[#171512]/70 shadow-[0_18px_55px_rgba(72,57,34,0.09)]">
          CyberSnap runs entirely on your machine. no accounts, no telemetry, no cloud dependencies. your screenshots never leave your computer unless you choose to upload them.
        </p>
      </Section>
